 ...
 * @subpackage Client
 */
class CampaignService extends \Kaltura\Client\ServiceBase
{
	 ...
	 * Add an object
	 * 
	 * @return \Kaltura\Client\Type\Campaign
	 */
	function add(\Kaltura\Client\Type\Campaign $objectToAdd)
	{
		$kparams = array();
		...
		$resultObject = \Kaltura\Client\ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaCampaign");
		$this->client->validateObjectType($resultObject, "\\Kaltura\\Client\\Type\\Campaign");
		return $resultObject;
	}
	 ...
	 * @return \Kaltura\Client\Type\Campaign
	 */
	function update($id, \Kaltura\Client\Type\Campaign $objectToUpdate)
	{
		$kparams = array();
	...
	function listAction(\Kaltura\Client\Type\CampaignFilter $filter, \Kaltura\Client\Type\FilterPager $pager = null)
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = \Kaltura\Client\ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaCampaignListResponse");
		$this->client->validateObjectType($resultObject, "\\Kaltura\\Client\\Type\\CampaignListResponse");
		return $resultObject;
	}
