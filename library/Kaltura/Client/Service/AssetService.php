...
class AssetService extends \Kaltura\Client\ServiceBase
{
	 ...
	 */
	function count(array $groupBy, \Kaltura\Client\Type\SearchAssetFilter $filter = null)
	{
		$kparams = array();
		foreach($groupBy as $index => $obj)
		{
			$this->client->addParam($kparams, "groupBy:$index", $obj->toParams());
		}
		if ($filter !== null)
