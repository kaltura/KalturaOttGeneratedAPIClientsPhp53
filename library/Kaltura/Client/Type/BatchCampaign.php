 ...
 * @subpackage Client
 */
class BatchCampaign extends \Kaltura\Client\Type\Campaign
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->populationConditions))
		{
			if(empty($xml->populationConditions))
				...
				$this->populationConditions = \Kaltura\Client\ParseUtils::unmarshalArray($xml->populationConditions, "KalturaCondition");
		}
	}
	/**
