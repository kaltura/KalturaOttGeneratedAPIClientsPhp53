 ...
 * @subpackage Client
 */
abstract class AssetLifeCycleTransitionAction extends \Kaltura\Client\Type\AssetRuleAction
{
	 ...
	 * @var \Kaltura\Client\Enum\AssetLifeCycleRuleActionType
	 */
	public $assetLifeCycleRuleActionType = null;

	/**
	 * Asset LifeCycle Rule Transition Type
	 * @var \Kaltura\Client\Enum\AssetLifeCycleRuleTransitionType
	 * @readonly
	 */
