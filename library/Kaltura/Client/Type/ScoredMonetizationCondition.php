 ...
 * @subpackage Client
 */
class ScoredMonetizationCondition extends \Kaltura\Client\Type\BaseSegmentCondition
{
	public function getKalturaObjectType()
	{
		return 'KalturaScoredMonetizationCondition';
	}
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->actions))
		{
			if(empty($xml->actions))
				...
				$this->actions = \Kaltura\Client\ParseUtils::unmarshalArray($xml->actions, "KalturaMonetizationCondition");
		}
	}
	/**
	 ...
	 * @var array<KalturaMonetizationCondition>
	 */
	public $actions;
