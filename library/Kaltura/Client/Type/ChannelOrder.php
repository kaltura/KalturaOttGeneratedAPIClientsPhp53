 ...
 * @subpackage Client
 */
class ChannelOrder extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->dynamicOrderBy) && !empty($xml->dynamicOrderBy))
			$this->dynamicOrderBy = \Kaltura\Client\ParseUtils::unmarshalObject($xml->dynamicOrderBy, "KalturaDynamicOrderBy");
	 ...
	 * @var \Kaltura\Client\Type\DynamicOrderBy
	 */
	public $dynamicOrderBy;

	/**
	 * Channel order by
	 * @var \Kaltura\Client\Enum\ChannelOrderBy
	 */
	public $orderBy = null;
